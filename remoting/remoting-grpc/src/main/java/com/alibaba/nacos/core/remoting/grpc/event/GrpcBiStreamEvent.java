 ...
 */
public class GrpcBiStreamEvent extends ClientRequestStreamEvent {

    public GrpcBiStreamEvent(Object source, Object value, Class<? extends Event> eventType) {
        super(source, value, eventType);
    }

    @Override
    public GrpcBiStreamInteractive getValue() {
